...
(function() {
  ...
  EkkoLightbox.prototype = {
      ...
      if (!this.options.remote) {
        ...
        if (this.gallery) {
          ...
          if (this.options.directional_arrows && this.gallery_items.length > 1) {
            this.lightbox_container.prepend('<div class="ekko-lightbox-nav-overlay"><a class="' + this.strip_stops(this.options.left_arrow_class) + '"></a><a class="' + this.strip_stops(this.options.right_arrow_class) + '"></a></div>');
            this.modal_arrows = this.lightbox_container.find('div.ekko-lightbox-nav-overlay').first();
            this.left_arrow = this.lightbox_container.find('a' + this.strip_spaces(this.options.left_arrow_class));
            this.left_arrow.on('click', function(event) {
              event.preventDefault();
              return _this.navigate_left();
            });
            this.right_arrow = this.lightbox_container.find('a' + this.strip_spaces(this.options.right_arrow_class));
            this.right_arrow.on('click', function(event) {
              event.preventDefault();
    ...
    preloadImage: function(src, onLoadShowImage) {
      ...
      var auto_fit = function(obj,maxW,maxH){
         var imgW=obj.width;
         var imgH=obj.height;
         var ratioA = imgH/imgW;
         var ratioB = imgW/imgH;
